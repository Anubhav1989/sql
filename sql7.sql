...
(109, 9, '2024-01-22', 90.00),
(110, 10, '2024-01-25', 60.00);
...
select c.cid,c.customer_name,o.order_id,o.amount from customers as c
natural  join orders as o;

select c.customer_name,sum(o.amount) from customers as c
join orders as o on c.cid=o.customer_id
group by c.customer_name order by o.amount desc;